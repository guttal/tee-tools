...
author: "Krishnapriya Tamma and Vishwesha Guttal"
date: "13 July 2016"
...
*Note to team leader* Please ensure that the volunteer or assistant has read and understood this document before s/he joins the team, and is aware of all the people mentioned in the document. 
...
Please make a note of the name and number of the law enforcing office closest to your field station. This can be the police or the district magistrate as you deem necessary. Team leader should have list of names of phone numbers at all times and share with other team members. (Team leader should also have list of names and phone numbers of all team members and their emergency contacts at all times). 

The following can be considered as informal guidelines as pertaining to sexual harassment that any team member can face as part of the work. This policy is gender neutral - that is applicable to males and female employees and volunteers of this project. 

### Scope of the policy
This policy is applicable to 
   * All people associated with the project, employed or volunteers
   ...
   * All allegations of sexual harassment by an employee against non-employee while on active duty (Note: that these can also be taken to the police).
...
This is not an exhaustive list, and there may be certain situations that are not part of the framework outlined above that could constitute harassment. We encourage you to talk to the team leaders or to me if you are uncertain. Often, we assume that we are over-reacting, although we may be justified in feeling violated. Please make sure to talk with any of us that you trust to clarify any doubts. 
...
Note: If the problem is severe, and if you fear for your safety please remove yourself from the situation till appropriate measures have been taken. Please do not take any risks, or ‘try to adjust’. 

## Filing of the complaints

This is an informal policy document, and when a complaint is made, it is appropriate that it then be handed over to the __institute committee__. Since the volunteers may not be employees of the committee, it has to pass to the PI or a senior student member. Since most employees and volunteers are likely to be in field when any untoward incident occurs, please follow the chain of command to make complaints. Complains may be lodged either verbally or in written. In field, please pass on your complaints to the Team Leader / PI directly. 
...
If the complaint is against KT, please lodge complaint with Dr. Vishwesha Guttal (VG), who is KT’s current advisor, after notifying the team leader. VG will then take the complaint forward and take appropriate action. If the complaint is against VG, please lodge complaint with __any other member__ (?) of CES/IISc. A couple of contacts have been provided at the end of this document along with all other contact details. 
...
(if emergency, call CES office 080-23600985 and ask to be connected to Uma)

Other IISc contacts: ??

## Some issues to think

For example, what should a team member do if he or she is casually told about a sexual harassment incident; i.e. not in the form of a complain? Should the team member mandatorily report it onwards? Should the team member try to investigate the incident? Should the team member actively provide interim relief?
