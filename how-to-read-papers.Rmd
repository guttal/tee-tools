---
title: "how-to-read-papers (skills)"
...
## Critique the paper
   + Big Picture: Is the question being addressed important enough? 
   + Does paper change the way you think about something, or is it a minor incremental knowledge?
...
## Summarize the paper
If you are the reviewer of this paper for a journal, what would you write? Your summary of a paper could follow that format. 

   + Summarize what they have done
      + What is the broad background in which these research questions (two sentences)? 
      + The questions that authors are trying to address (two to three sentences).  
      + State their methods (two-three sentences). 
      + State their answers and conclusions (four to five sentences). If you can write all these on your own, you have actually understood the paper! 
      
   + Now write your view of the paper:
      + State novelties and nice things the paper. Strengths in terms qn, method, etc. 
      + State major/fundamental issues with the paper. 
      + State limitations of the assumptions, methods, inferences, etc. 
      + Now write about key but minor improvements on figures, captions, writing, etc. 
