...
As a general rule, the lab adviser will be a corresponding author for manuscripts arising out of lab’s main research projects. However, we encourage students also to be corresponding authors (sometimes called co-corresponding authors). 
...
Short-term students will qualify to be authors on lab manuscripts if they contribute in one or both of the following ways:
   + In general, if they have contributed a figure to the manuscript with substantial technical and analytical inputs and if they understand its interpretation correctly along with the broader context of the paper, they should qualify as coauthors, even if it the idea was not their own. 
   + They are involved in the writing of the manuscript (i.e., a good part of it).  

Long-term PhD students, post-docs  and project assistants, at the stage of writing their papers, should try and involve short-term students who have previously worked on the project.. If they have already left the lab, ask if they would be interested in participating. If they are in some other lab, make sure they get their current advisers’ consent. If they cannot participate in writing, re-assess their contribution at the end of completion of writing the manuscript. 

## Acknowledging assistance 

Students who did not qualify as coauthors but did some work in the lab on that project should be properly acknowledged in the acknowledgement section of the manuscript (preferably with specific contribution made). They should be sent a copy of the draft of the manuscript soliciting comments. If the adviser and later students who worked on the project think it is appropriate, they may ask whether the first student is expecting an authorship. 
...
There are various cultural factors that differ from discipline to discipline that determines authorship order. In ecology, typically the lab PI is the last author (also called senior author - I hate this usage). Among the student contributors, the one with maximum contribution will be the first author. Remaining are listed from second author onwards either in decreasing order of contribution or alphabetically. The acknwoledgement section should be used to described to provide details of individual contributions. 
...
Answer would be an yes if the better design was thought of by the student. 
